...
public class LinguisticVariablesLoader {
    public static List<LinguisticVariable> load(CrispSet universe) {
        ...
        map.put("a_bit", new TriangularFunction(ColumnMap.fat, 1, 4, 9));
        ...
        map.put("a_bit", new TriangularFunction(ColumnMap.alcohol, 0.5, 2, 3.5));
        map.put("medium", new TriangularFunction(ColumnMap.alcohol, 2, 16, 25));
        map.put("strong", new RisingFunction(ColumnMap.alcohol, 20, 25));
        variables.add(new LinguisticVariable("alcohol", map, universe));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.calcium, 450, 550));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.cholesterol, 150, 200));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.energy, 1500, 1700));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.iron, 20, 28));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.magnesium, 180, 200));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.moisture, 85, 90));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.protein, 15, 20));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.starch, 45, 50));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.sugars, 45, 50));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.vitaminA, 900, 1100));
        ...
        map.put("a_lot", new RisingFunction(ColumnMap.vitaminC, 900, 1100));
